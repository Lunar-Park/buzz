 ...
 * than a rule a component has to remember. Connected agents are also filtered
 * out of `listManagedAgents()` on the backend, so they can never reach a
 * surface that renders lifecycle controls.
 */
